...
import green from './Photos/green1417.jpg'
const GreenDigital = () => {
				...
				<div className="lg:w-4/5 mx-auto flex flex-wrap">
					...
					<div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
						...
						<p className="leading-relaxed">
							Full speed general purpose green sensitive x-ray film for use with
							rare earth green emitting screens or calcium tungstat screens.
							General purpose full speed green sensitive x-ray film for use with
							rare earth green emitting screens or calcium tungstat screens.
							Sold in 80 sheet boxes.
						</p>
