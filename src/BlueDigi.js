...
import blue from './Photos/blue1012.jpg'
const BlueDigital = () => {
	const [selectedSize, setSelectedSize] = useState('')
	const [price, setPrice] = useState('Rs 9000')
	...
	useEffect(() => {
		...
		if (priceMap[selectedSize]) {
			setPrice(`Rs ${priceMap[selectedSize]}`)
		} else {
